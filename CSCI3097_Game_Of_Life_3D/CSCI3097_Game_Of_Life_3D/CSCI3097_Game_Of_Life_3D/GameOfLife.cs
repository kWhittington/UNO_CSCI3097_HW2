...
namespace CSCI3097_Game_Of_Life_2D
{
  ...
  public class GameOfLife : Microsoft.Xna.Framework.Game
  {
    ...
    protected override void Initialize()
    {
      ...
      //Components.Add(new Grid(this, 100, 100, GraphicsDevice.Viewport.X+100,
      //  GraphicsDevice.Viewport.Y, GraphicsDevice.Viewport.Width-200,
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      model.Draw(Matrix.Identity,
        ...
        Matrix.CreatePerspectiveFieldOfView(MathHelper.PiOver2,
